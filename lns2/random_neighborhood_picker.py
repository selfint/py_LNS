...
class RandomNeighborhoodPicker(NeighborhoodPicker):
    ...
    def pick(self, paths: dict[int, List[int]]):
        ...
        number_of_total_collisions = sum([agent_collisions_pair[1] for agent_collisions_pair in agents_collisions_list])
        weights = [collisions/number_of_total_collisions for _agent, collisions in agents_collisions_list]
